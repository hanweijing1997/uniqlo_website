...
$.extend(Banner.prototype, {
  ...
  animateLayout: function animateLayout() {
  ...
  padinationLayout: function padinationLayout() {
  ...
  changePagition: function changePagition() {
  ...
  clickPagition: function clickPagition(evt) {
